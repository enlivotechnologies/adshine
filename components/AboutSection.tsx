      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 lg:gap-12 mb-16 lg:mb-24">
          <div className="lg:col-span-1">
            <p className="text-[13px] font-medium text-[#888888] flex items-center tracking-wide">
              <span className="text-[18px] mr-3 leading-none relative -top-[1.5px] text-[#b5b5b5]">•</span> 
              About Adshine
            </p>
          </div>
          <div className="lg:col-span-3 lg:pr-12">
            <h2 className="text-[#1a1a1a] text-[20px] md:text-[22px] lg:text-[24px] xl:text-[28px] leading-[1.45] font-medium tracking-tight">
        ...
        {/* Stats Section */}
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12 lg:mb-16 text-center">
          {stats.map((stat, index) => (
            <div key={index} className="flex flex-col">
              <span className="text-[24px] lg:text-[28px] font-medium text-[#111111] mb-2.5 tracking-tighter">
                {stat.value}
              </span>
              <span className="text-[13px] text-[#888888] font-medium leading-[1.5]">
                {stat.label1}
                <br />
                {stat.label2}
              </span>
