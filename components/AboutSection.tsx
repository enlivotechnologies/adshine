  ...
  return (
    <section className="bg-white font-sans">
      <div className="w-full max-w-[1600px] mx-auto px-3 md:px-4 lg:px-6">
        <div className="bg-[#F4F7FB] rounded-[2.5rem] rounded-bl-[0] rounded-br-[0] py-16 lg:py-24 px-8 md:px-16 lg:px-24">
        {/* Top Section */}
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 lg:gap-12 mb-16 lg:mb-24">
          <div className="lg:col-span-1">
            <p className="text-[18px] font-medium text-blue-600/80 flex items-center tracking-wide">
        ...
        {/* Divider */}
        <div className="w-full h-[1px] bg-[#E2E8F0] mb-12 lg:mb-16"></div>

        {/* Stats Section */}
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 ">
          {stats.map((stat, index) => (
            <div key={index} className="flex flex-col items-center text-center">
              <span className="text-[20px] lg:text-[28px] font-semibold text-[#0057D9] mb-2.5 tracking-tighter drop-shadow-sm">
                {stat.value}
              </span>
              <span className="text-[14px] lg:text-[15px] text-[#64748B] font-medium leading-[1.5]">
                {stat.label1}
                <br />
                {stat.label2}
              </span>
